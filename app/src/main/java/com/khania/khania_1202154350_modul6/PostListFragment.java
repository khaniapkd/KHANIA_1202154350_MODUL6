...
public abstract class PostListFragment extends Fragment {
    ...
    private FirebaseRecyclerAdapter<PostModel, PostViewHolder> mAdapter;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        FirebaseRecyclerOptions options = new FirebaseRecyclerOptions.Builder<PostModel>()
                ...
                .setQuery(postsQuery, PostModel.class)

                .build();



        mAdapter = new FirebaseRecyclerAdapter<PostModel, PostViewHolder>(options) {
            ...
            protected void onBindViewHolder(PostViewHolder viewHolder, int position, final PostModel model) {
                ...
                viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        intent.putExtra(DetailPostActivity.EXTRA_POST_KEY, postKey);
